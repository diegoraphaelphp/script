...
function Salvar(){ 
    ...
    if($.trim($("#selMenu").val()) == ""){
        ...
        $("#dialog-atencao").html("Por favor, selecione o Menu do Nível 2.");         
        $('#dialog-atencao').dialog('open');
        return;
    }    
    if($("#ckbStatus").is(":checked")){
        valorStatus = "I";
                ...
                $.post("controladores/MenuNivel3Controlador.php", {
                    acao: "Salvar",
                    id: $("#hddCodigo").val(),
                    nome: $.trim($("#txtNome").val()),
                    caminho: $.trim($("#txtCaminho").val()),
                    menu2: $.trim($("#selMenu").val()),
                    status : valorStatus
...
function ExibirDadosGrid(){
    ...
    dg.datagrid({
        jsonStore: {
            url: "controladores/MenuNivel3Controlador.php"
                                    ...
                                    html += '<tr>';
                                        html += '<td valign="top">';
                                            html += '<table cellpadding="5">';
                                                ...
                                                html += '</tr>'; 
                                                html += '<tr>';
                                                    html += '<td bgcolor="#F4F4F4" align="right"><b>Menu Nível 2</b></td>';
                                                    html += '<td>' + data.rows[0].menu2 + '</td>';
                                                html += '</tr>';
                                                html += '<tr>';
                    ...
                    $.post("controladores/MenuNivel3Controlador.php", {
                        ...
                        function(data) {                            
                            if(data.sucesso == "true"){
                                ...
                                $("#selMenu").val(data.rows[0].menu2_id);
        ...
        ,mapper:[{
            ...
            name: 'nome',title:'Menu Nível 3',width:500,align:'left'
        },{ 
              name: 'menu2',title:'Menu Nível 2',width:500,align:'left'
        },{          
