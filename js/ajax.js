...
function pega_valor(valor, tipo){
	...
	if (tipo == "incluirItensCompra"){
       ...
       getResponse("pega_validausuario","../lib/Fachada.php?acao="+document.getElementById("acao10").value+"&id="+valor,"", topo);
       
    }else if (tipo == "validausuario2"){
		
      getResponse("pega_validausuario2","../lib/Fachada.php?acao="+document.getElementById("acaovalida").value+"&id="+valor+"&id2="+document.getElementById("id").value,"", topo); 	  
       ...
       getResponse("pega_exibebtnusu","../lib/Fachada.php?acao="+document.getElementById("acao11").value+"&id="+valor,"", topo); 
       
    }else if (tipo == "exibirbtnusu2"){
        
       getResponse("pega_exibebtnusu2","../lib/Fachada.php?acao="+document.getElementById("acaobtn").value+"&id="+valor+"&id2="+document.getElementById("id").value,"", topo);
       
    }else if (tipo == "addAtividades"){ 
	
       getResponse("incluirAtv","../lib/Fachada.php?acao="+document.getElementById('acao').value+"&idp="+document.getElementById("idp").value+"&nome="+document.getElementById('nome').value+"&status="+document.getElementById('status').value+"&und="+document.getElementById('und').value+"&tipo="+document.getElementById('tipo').value,"", topo);
       ...
       getsfiltro1("../consultas/lista_atividades.php", document.getElementById("idp").value, "codtp", "DESC");
       getsfiltro1("../consultas/lista_atividades.php", document.getElementById("idp").value, "codtp", "DESC");

    }else if (tipo == "excAtividades"){
		
    	getResponse("excluirAtv", "../lib/Fachada.php?acao="+document.getElementById('acaoexc').value+"&id="+valor,"", topo);
...
//			getsfiltroCOMPRAS('lista_compras.php', '', 'codtp', '');
		...
		getResponse("pegaValidaITEM","../ajax/ajax_valida_btnitem.php?id="+document.getElementById("idcli").value+"&qtd="+document.getElementById("qtd").value+"&mod="+document.getElementById("mod").value+"&idprd="+document.getElementById("id_nome").value+"&tipo="+document.getElementById("tipo").value+"&idped="+document.getElementById("id").value,"", topo);        
        //getResponse("pegaQTDRestante","../ajax/ajax_calc_restante.php?id="+document.getElementById("idcli").value+"&qtd="+document.getElementById("qtd").value+"&mod="+document.getElementById("mod").value+"&idprd="+document.getElementById("id_nome").value+"&tipo="+document.getElementById("tipo").value+"&idped="+document.getElementById("id").value,"", topo);
...
//		document.getElementById("estoque").value			  = "";
		...
		pega_valor2(document.getElementById("idcli2").value, 'pega_saldo');

	}else if (tipo == "pega_inclusao_detalhe"){

		getResponse("incluirDetPedido","../ajax/ajax_incluir_detalhe_pedido.php?id="+document.getElementById("id").value+"&idprd="+document.getElementById("id_nome").value+"&valor="+document.getElementById("preco").value+"&qtd="+document.getElementById("qtd").value,"", topo);
...
//		getResponse("pegaCalculaTotalSemanal","../ajax/ajax_calculo_semana.php?id="+valor+"&mod="+document.getElementById("mod").value,"", topo);	
       ...
       if (document.getElementById("conso1").checked == true) var con = "D"; else var con = "G";

	   getResponse("pegaQtdMUN","../ajax/ajax_qtd_municipio.php?id="+valor+"&id2="+param+"&tipo="+document.getElementById("tipo").value+"&con="+con,"", topo);       

	}else if (tipo == "pega_valida_incluir_item_nfe"){
	   
       getResponse("pegaQTDRestante","../ajax/ajax_calc_restante.php?id="+document.getElementById("idcli").value+"&qtd="+document.getElementById("qtd").value+"&mod="+document.getElementById("mod").value+"&idprd="+document.getElementById("id_nome").value+"&tipo="+document.getElementById("tipo").value+"&idped="+document.getElementById("id").value,"", topo);       
       getResponse("valorProduto","../ajax/ajax_verifica_valor_produto.php?valor="+document.getElementById("prec").value+"&qtd="+document.getElementById("qtd").value,"", topo);
       getResponse("pegaValidaITEM","../ajax/ajax_valida_btnitem.php?id="+document.getElementById("idcli").value+"&qtd="+document.getElementById("qtd").value+"&mod="+document.getElementById("mod").value+"&idprd="+document.getElementById("id_nome").value+"&tipo="+document.getElementById("tipo").value+"&idped="+document.getElementById("id").value,"", topo);
       
       getResponse("pegaCalculaSaldo","../ajax/ajax_saldo.php?id="+document.getElementById("id_nome").value+"&qtd="+document.getElementById("qtd").value+"&mod="+document.getElementById("mod").value+"&valor="+document.getElementById("valorProduto").innerHTML,"", topo);
       getResponse("pegaCalculaTotal","../ajax/ajax_calcula_total.php?qtd="+document.getElementById("qtd").value+"&valor="+document.getElementById("preco").value+"&mod="+document.getElementById("mod").value,"", topo);

	}else if (tipo == "pega_dados_muni_unid"){
 
        getResponse("pegaMuniUnid","../lib/Fachada.php?acao="+document.getElementById("acao9").value+"&unidade="+document.getElementById("unidade").value+"&municipio="+document.getElementById("municipio").value+"&nomeusuario="+document.getElementById("nomeusuario").value+"&loginusuario="+document.getElementById("loginusuario").value+"&emailusuario="+document.getElementById("emailusuario").value+"&foneusuario="+document.getElementById("foneusuario").value,"", topo);

        alert("Registro atualizado com sucesso.");        
        parent.location = "../lib/Fachada.php?acao="+document.getElementById("acao8").value;
        
	}else if (tipo == "pega_importa_sigater"){
 
        getResponse("validaImportacao","../lib/Fachada.php?acao="+document.getElementById("acao").value,"", topo);
        
        alert("Importação concluída com sucesso.");
        
	}else if (tipo == "pega_usu_gere"){
	   //alert(document.getElementById("xips").value+' teste');
       getResponse("pegaUsuGere","../ajax/ajax_usu_gere.php?id="+valor+"&xips="+document.getElementById("xips").value+"&gere="+document.getElementById("gere").value+"&idmuni="+param,"", topo);

	}else if (tipo == "pega_muni_gere"){

        getResponse("pegaMuniGere","../ajax/ajax_muni_gere.php?id="+valor+"&par="+param,"", topo);
        
	}else if (tipo == "pega_qtd_exec"){

      getResponse(valor,"../ajax/ajax_qtd_exec.php?id="+valor+"&qtd="+param,"", topo);

	}else if (tipo == "pega_atualiza_qtd_exec"){

      getResponse("atualizaEXEC","../lib/Fachada.php?acao="+document.getElementById("acaoexec").value+"&qtd="+valor+"&lista="+param,"", topo);
      
      document.getElementById("resultado").innerHTML = "";
      alert("Registro atualizado com sucesso.");
      getsfiltroEXEC('lista_rde.php', '', 'codtp', 'DESC');
      
	}else if (tipo == "pega_qtd_exec2"){

      getResponse(valor,"../ajax/ajax_qtd_exec2.php?id="+valor+"&qtd="+param,"", topo);

	}else if (tipo == "pega_atualiza_qtd_exec2"){

      getResponse("atualizaEXEC","../lib/Fachada.php?acao="+document.getElementById("acaoexec2").value+"&qtd="+valor+"&lista="+param,"", topo);
      ...
      getsfiltroEXEC('lista_rde.php', '', 'codtp', 'DESC');
	   ...
	   document.getElementById("flag").value = valor;

       var par = "";
       if (document.getElementById("acess").value == "0"){
         par = "&mun="+document.getElementById("mun").value;            
       }
       ...
       getResponse("pegaQTDAgr","../ajax/ajax_qtd_planos_executados.php?flag="+flag+"&tipo="+param+"&ano="+document.getElementById("ano").value+par+"&dtini="+document.getElementById("dtini").value+"&dtfim="+document.getElementById("dtfim").value,"", topo);       
       getResponse("pegaQTDAgr2","../ajax/ajax_total_agricultores.php?flag="+flag+"&tipo="+param+par,"", topo);
       getResponse("pegaQTDTecnico","../ajax/ajax_qtd_tecnicos.php?flag="+flag+"&tipo="+param+"&ano="+document.getElementById("ano").value+par,"", topo);
       getResponse("exibirMunicipios","../ajax/ajax_municipios.php?id="+valor+"&flag="+flag+"&idconso="+param+par,"", topo);
        ...
        getResponse("exibirMunicipios","../ajax/ajax_municipios.php?id="+valor+"&flag="+flag+"&idconso="+param+"&dtini="+document.getElementById("dtini").value+"&dtfim="+document.getElementById("dtfim").value,"", topo);
        getResponse("pegaQTDAgr","../ajax/ajax_qtd_planos_executados.php?flag="+flag+"&tipo="+document.getElementById("tipo").value+"&ano="+document.getElementById("ano").value+"&dtini="+document.getElementById("dtini").value+"&dtfim="+document.getElementById("dtfim").value,"", topo);
        getResponse("pegaQTDAgr2","../ajax/ajax_total_agricultores.php?flag="+flag+"&tipo="+param,"", topo);
        getResponse("pegaQTDTecnico","../ajax/ajax_qtd_tecnicos.php?flag="+flag+"&tipo="+document.getElementById("tipo").value+"&ano="+document.getElementById("ano").value,"", topo);
        
    }else if (tipo == "pega_datas_acompanhamento"){

        if (document.getElementById("conso1").checked) var flag = "RD"; else var flag = "GR";
        document.getElementById("flag").value = flag;
        
        getResponse("pegaQTDAgr","../ajax/ajax_qtd_planos_executados.php?flag="+flag+"&tipo="+document.getElementById("tipo").value+"&ano="+document.getElementById("ano").value+"&dtini="+document.getElementById("dtini").value+"&dtfim="+document.getElementById("dtfim").value+"&mun="+document.getElementById("mun").value,"", topo);

    }else if (tipo == "pega_exibir_qtd"){
        
        if (document.getElementById("conso1").checked) var flag = "RD"; else var flag = "GR";

        getResponse("pegaQTDAgr","../ajax/ajax_qtd_planos_executados.php?flag="+flag+"&tipo="+document.getElementById("tipo").value+"&ano="+document.getElementById("ano").value+"&mun="+document.getElementById("mun").value+"&dtini="+document.getElementById("dtini").value+"&dtfim="+document.getElementById("dtfim").value,"", topo);
        getResponse("pegaQTDAgr2","../ajax/ajax_total_agricultores.php?flag="+flag+"&tipo="+param+"&mun="+document.getElementById("mun").value,"", topo);
        getResponse("pegaQTDTecnico","../ajax/ajax_qtd_tecnicos.php?flag="+flag+"&tipo="+document.getElementById("tipo").value+"&ano="+document.getElementById("ano").value+"&mun="+document.getElementById("mun").value,"", topo);

	}
}

// gambi neritonio e gilberto
function pega_valor_elaboracao(){
    var idmun = document.getElementById("mun").value;
    var idproj = document.getElementById("proj").value;
    ...
    // guarda o municipio
    document.getElementById("idmunsel").value = idmun;
    
    var topo = "<span style='font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;font-weight:bold;color:#000066;font-style:normal;text-decoration:none;'><img src='../img/ajax-loader.gif' title='Carregando...' />&nbsp;Carregando...</span>";
    getResponse("pega_atividades","../ajax/ajax_exibe_atividades_elaboracao.php?id=" + idproj + "&idmun=" + idmun,"", topo);
}