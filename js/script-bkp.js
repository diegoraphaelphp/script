...
function getsfiltroUSU(arq, cod, ordem, tpord){	
	...
	var par  = "&status="+status+"&nome="+nome+"&ordem="+ordem+"&tpordem="+tpord+"&lista="+lista+"&lista2="+lista2;
	if (pag == "") pag = 10;
...
function getsfiltroPA(arq, cod, ordem, tpord){	
        if(document.getElementById("tipo").value == ''){
            alert("Por favor, selecione uma Região de Desenvolvimento ou Gerência Regional.");
            return;
        }
    ...
    loadXMLDoc2(arq+"?ano="+ano+"&proj="+proj+"&mun="+mun+"&mod="+document.getElementById("mod").value+"&flag="+flag+"&idconso="+document.getElementById("tipo").value+"&acess="+acess);
}
